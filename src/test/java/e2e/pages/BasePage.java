...
public class BasePage {
    ...
    private Process setCompareCommandToTerminal(String referenceImageFilePath, String tmpFilePath) throws IOException {
        ProcessBuilder pb = new ProcessBuilder("C:\\Program Files\\\"C:\\Program Files\\ImageMagick-7.1.1-Q16-HDRI\\magick.exe", "compare", "metric", "AE", referenceImageFilePath, tmpFilePath, "null:");
